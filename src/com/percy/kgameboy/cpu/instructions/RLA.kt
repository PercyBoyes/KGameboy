...
class RLA(private val a: Register8, private val flags: Flags,
          override val opCode: UByte) : Instruction {
    override val name = "RLA"
    override val description = "Rotates bits in ${a.name} to the left, through the carry flag."
    ...
    override fun run(operand: UByteArray) : Int {
        ...
        shiftLeft(a)
        a.set(setBit(a.getUnsigned(), 0, flags.isCarrySet()))
        flags.setCarry(bit7)
