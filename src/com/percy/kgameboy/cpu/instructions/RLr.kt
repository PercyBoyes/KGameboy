...
class RLr(private val src: Register8, private val flags: Flags,
          override val opCode: UByte) : Instruction {
    override val name = "RL ${src.name}"
    override val description = "Rotates bits in ${src.name} to the left, through the carry flag."
    ...
    override fun run(operand: UByteArray) : Int {
        ...
        shiftLeft(src)
        src.set(setBit(src.getUnsigned(), 0, flags.isCarrySet()))
