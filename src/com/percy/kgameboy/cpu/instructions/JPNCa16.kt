...
class JPNCa16(private val pc: Register16, private val flags: Flags, override val opCode: UByte) : Instruction {
    override val name = "JP NC, a16"
    override val description = "Jump to address if carry flag is not set"
