...
class CALLNCa16(private val pc: Register16, private val stack: Stack,
                private val flags: Flags, override val opCode: UByte) : Instruction {
    override val name = "CALL NC d16"
    override val description = "Calls subroutine at address provided in operand if Carry flag is not set"
